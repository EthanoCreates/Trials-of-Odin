using System;
using UnityEngine;
public class PlayerAerialMovementState : PlayerState
{
    ...
    public PlayerAerialMovementState(PlayerUtilities utilities , PlayerStateMachine.EPlayerState stateKey) : base(utilities, stateKey) { }
