...
public class PlayerSoundManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PlayerSoundRequestor soundRequestor = PlayerStateMachine.LocalInstance.AudioRequestor;
    ...
    private void SoundRequestor_OnHurt(object sender, EventArgs e)
    {
        hurtSounds.Play();
    }

    private void SoundRequestor_OnRollLand(object sender, EventArgs e)
    {
        rollSound.Play();
    }

    private void AudioRequestor_OnLandSound(object sender, EventArgs e)
    {
        landSound.Play();
    }

    private void AudioRequestor_OnJumpSound(object sender, EventArgs e)
    {
        jumpSound.Play();
    }
    ...
    {
        if(PlayerStateMachine.LocalInstance.currentState.CurrentSubState.StateKey == PlayerStateMachine.EPlayerState.Run)
        {
