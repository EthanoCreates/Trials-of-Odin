...
{
    public EnemyContext(EnemyStateMachine enemyStateMachine, NavMeshAgent agent, Transform transform, LayerMask groundLayers, float walkSpeed, float runSpeed, HealthForRagdolls health, EnemyWeapon primaryWeapon, EnemyShield shield) : base(new EnemyStats())
    {
