...
namespace TrialsOfOdin.Combat
{
    public abstract class Weapon : DamageSource
    {
        ...
        public override void HitCharcter(Collision collision)
        {
        ...
        {
            //if (collision.collider.TryGetComponent(out RA2BoneCollisionHandler bone))
            //{
            //    charactersHit.Add(bone.ParentRagdollAnimator.GetComponent<DamageHandler>());
            //}
        ...
        private void SetDamageData()
        {
            AttackID++;
            charactersHit.Clear();
            DamageDealt = damageMultiplier * weaponData.damage;
